...
class AuthenticateGui(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_authenticate = QtWidgets.QPushButton(self.frame_1)
        self.btn_authenticate.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/ubuntu/odrive-x/icon/verified-account.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_authenticate.setIcon(icon1)
        self.btn_authenticate.setIconSize(QtCore.QSize(20, 20))
        self.btn_authenticate.setObjectName("pushButton")
        self.gridLayout.addWidget(self.btn_authenticate, 0, 1, 1, 1)
